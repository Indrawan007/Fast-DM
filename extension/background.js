...
const DEFAULT_CONFIG = {
  ...
  // v2.11.0: daftar DIPERLUAS ke 300+ jenis file — video, audio, gambar, arsip,
  // dokumen, installer, font, 3D, VM image, dll. Selaras dengan
  // DIRECT_FILE_EXTENSIONS di Rust (test extension_intercept_list_is_covered).
  videoExtensions: [
    ".3g2",
    ".3ga",
    ".3gp",
